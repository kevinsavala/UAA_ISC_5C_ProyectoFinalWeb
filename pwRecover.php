...
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
    ...
    <h1 style="margin-top:200px;color:red;text-align:center">Tu cuenta está bloqueada!</h1>
    <h4 style="text-align:center;color:white;">Para recuperarla, ingresa tu nombre de usuario:</h4>
    <h4 style="text-align:center;color:white;">Te enviaremos un correo electronico con una contraseña nueva.</h4>
    <div class="container" style="margin-bottom:200px">
        <form action="recover.php" method="post">
        <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        <label for="usuario" class="col-form-label" style="color:white;">Usuario</label>
                    </div>
                    <div class="col-auto">
        ...
        <div class="row g-3 align-items-center">
                    <br><button type="submit" class="btn btn-md btn-custom btn-roxo">Enviar correo</button>
                </div>
        </form>
    </div>
